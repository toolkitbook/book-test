...
![Figure 1. Argument processing class relations.](/book-test/static/img/flow.gif)
...
<tr class="odd">
<td align="left"><span class="nctnt ncbi-path">/corelib/</span></td>
<td align="left">Log message from source file located in <span class="nctnt ncbi-path">src/corelib</span> or <span class="nctnt ncbi-path">include/corelib</span></td>
<td align="left"><ul>
<li><p><span class="nctnt ncbi-path">src/corelib/ncbidiag.cpp</span></p></li>
<li><p><span class="nctnt ncbi-path">include/corelib/ncbidiag.hpp</span></p></li>
</ul></td>
...
<span> ![Image ch\_core\_log\_fmt\_app\_states.png](/book-test/static/img/ch_core_log_fmt_app_states.png)</span>
...
The <span class="nctnt ncbi-monospace">\<event\> \<message\></span> portion of the log output will have the format:
...
![Image ch\_core\_log\_fmt\_event.png](/book-test/static/img/test_img_ch_core.png)

An example of application events:

<span> </span>

![Image ch\_core\_log\_fmt\_event.png](/book-test/static/img/ch_core_log_fmt_event.png)
...
<span> [![Image ch\_core\_log\_fmt\_diagnostic.png](/book-test/static/img/ch_core_log_fmt_diagnostic.png)](/toolkit/doc/book/img/ch_core_log_fmt_diagnostic.png "Click to see the full-resolution image")</span>
...
All three log files have the same name but different extensions: <span class="nctnt ncbi-path"> .log</span>, <span class="nctnt ncbi-path">.err</span> and <span class="nctnt ncbi-path"> .trace</span>.
...
![Figure 2. Thread Life Cycle](/book-test/static/img/thread_life_cycle.gif)
